    ...
    <div className="space-y-3" role="region" aria-label="ROI metrics dashboard">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <Card className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-800">
          ...
          <div className="text-xl font-bold text-blue-700 dark:text-blue-300" data-testid="kpi-payback" aria-label={`Payback period: ${formatPayback(metrics!.paybackMonths)}`}>
        ...
        <Card className="p-4 bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900/20 dark:to-cyan-800/20 border-cyan-200 dark:border-cyan-800">
          <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 text-xs mb-1">
            <Scale className="h-3 w-3" aria-hidden="true" />
            <span>BCR</span>
          </div>
          <div className="text-xl font-bold text-cyan-700 dark:text-cyan-300" data-testid="kpi-bcr" aria-label={`Benefit Cost Ratio: ${metrics!.benefitCostRatio.toFixed(2)}x`}>
