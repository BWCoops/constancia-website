      ...
      <main className="pt-16 sm:pt-20 pb-16">
        <article className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-8">
            ...
            >
              <Badge variant="secondary" className="bg-[#C77A93]/10 text-brand-teal dark:text-brand-cyan">
          ...
          <div 
            className="prose prose-lg dark:prose-invert max-w-none mb-12 
              ...
              prose-blockquote:border-l-[#C77A93] prose-blockquote:bg-muted/30 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r-lg
              ...
              components={{
                ...
                h2: ({children}) => {
                  ...
                  return (
                    ...
                    >
                      <span className="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-gradient-to-b from-[#C77A93] to-[#7FB8A3]" />
                      {children}
                    </h2>
                  );
                },
                h3: ({children}) => (
                  <h3 
                    className="text-lg sm:text-xl font-semibold mt-8 mb-4 text-brand-teal dark:text-brand-cyan/80 border-l-2 border-[#C77A93]/50 pl-3"
                  >
                    {children}
                  </h3>
                ),
                ...
                ul: ({children}) => {
                  ...
                  return (
                    <div 
                      className="my-6 p-4 bg-gradient-to-br from-[#12161D]/5 via-transparent to-[#C77A93]/5 dark:from-[#12161D]/15 dark:to-[#C77A93]/10 border border-[#C77A93]/20 rounded-xl"
                    >
                ...
                li: ({children}) => (
                  <div className="flex items-start gap-2 py-1.5 px-2 rounded-md hover:bg-[#C77A93]/5 transition-colors group">
                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center mt-0.5 shadow-sm">
                ...
                blockquote: ({children}) => (
                  <blockquote 
                    className="my-8 border-l-4 border-[#C77A93] bg-gradient-to-r from-[#C77A93]/5 to-transparent py-5 px-6 rounded-r-lg italic text-muted-foreground"
                  >
                    {children}
                  </blockquote>
                ),
                ...
                hr: () => (
                  <div className="my-12 flex items-center gap-4">
                    <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#C77A93]/30 to-transparent" />
                    <div className="w-2 h-2 rounded-full bg-[#C77A93]/30" />
                    <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#C77A93]/30 to-transparent" />
                  </div>
                ),
          ...
          >
            {post.tags.map(tag => (
              <Badge key={tag} variant="outline" className="hover:bg-[#C77A93]/10 transition-colors">
