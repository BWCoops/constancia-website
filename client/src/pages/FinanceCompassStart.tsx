        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 pt-2">
            ...
            {existingAssessment && ["completed", "analysed", "report_generated"].includes(existingAssessment.status) ? (
              <>
                <Button
                  className="w-full bg-gradient-to-r from-[#12161D] to-[#8E4F67]"
          ...
          >
            ...
            <div className="grid lg:grid-cols-5 gap-6 lg:gap-8">
              <div className="lg:col-span-3">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <Button 
                      size="lg" 
                      className="w-full bg-gradient-to-r from-[#12161D] to-[#8E4F67] hover:from-[#8E4F67] hover:to-[#7FB8A3]"
                      disabled={startMutation.isPending}
              ...
              <div className="lg:col-span-2">
                <Card className="bg-gradient-to-br from-[#12161D] to-[#8E4F67] text-white border-0">
                  <CardHeader>
