...
const VENDOR_TIER_COLORS: Record<string, string> = {
  ...
  tier2: "bg-[#7FB8A3]/10 text-[#8E4F67] dark:bg-[#252826]/30 dark:text-[#7FB8A3]",
...
const SCORING_TIER_COLORS = [
  ...
  "bg-[#7FB8A3]/10 text-[#8E4F67] dark:bg-[#252826]/30 dark:text-[#7FB8A3]",
                          ...
                          <TableRow key={level}>
                            ...
                            <TableCell className="text-center">
                              <Badge className={
                                ...
                                data.score === 4 ? "bg-[#7FB8A3]/10 text-[#8E4F67] dark:bg-[#252826]/30 dark:text-[#7FB8A3]" :
