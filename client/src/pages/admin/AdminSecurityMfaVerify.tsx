...
export default function AdminSecurityMfaVerify() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#252826] to-[#0d4a7c] flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 bg-white shadow-2xl">
        ...
        <div className="mt-8 p-4 bg-[#7FB8A3]/10 rounded-md flex gap-3">
          <ShieldCheckIcon className="w-5 h-5 text-[#252826] flex-shrink-0 mt-0.5" />
