                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <RadarChart data={radarData}>
                        ...
                        {sortedScores.map((platform, index) => {
                          const colours = ["#7FB8A3", "#8E4F67", "#5E8D7A", "#12161D", "#6366f1", "#8b5cf6"];
                          return (
                            <Radar
                              key={platform.id}
                              name={platform.shortName}
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#12161D] to-[#8E4F67] flex items-center justify-center text-white font-bold text-lg">
                      {platform.logo}
                    </div>
                    <div>
                  ...
                  <Card key={platform.id} className="border-[#7FB8A3]/30">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#12161D] to-[#8E4F67] flex items-center justify-center text-white font-bold text-sm">
                          {platform.logo}
                        </div>
                        <div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section className="py-12 md:py-16 lg:py-24 lg:pb-40 bg-gradient-to-r from-[#12161D] via-[#5E8D7A] to-[#8E4F67]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {flags.contact && (
                  <Link href="/contact">
                    <Button
                      size="lg"
                      className="bg-[#7FB8A3] text-[#12161D] hover:bg-[#08CCF9]"
