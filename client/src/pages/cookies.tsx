  ...
  return (
    <div className="min-h-screen page-dark">
      <SEOHead
        ...
        description="How Constancia GROUP LIMITED uses cookies and similar technologies on our website. Details on cookie categories, your choices, and UK data protection compliance."
