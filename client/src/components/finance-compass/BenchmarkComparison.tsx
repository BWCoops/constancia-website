      ...
      <div className="space-y-1.5">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 bg-muted rounded-full h-2.5 overflow-hidden">
            <div 
              className="h-full bg-[#7FB8A3] rounded-full transition-all duration-500"
            ...
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div>
                <CardTitle className="flex items-center gap-2">
                  <BarChart3 className="h-5 w-5 text-[#7FB8A3]" />
                  {title}
                </CardTitle>
            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Bar dataKey="yourScore" fill="#7FB8A3" radius={[0, 4, 4, 0]} name="yourScore" />
          ...
          <div className="mt-6 pt-4 border-t flex flex-wrap items-center justify-between gap-2 text-xs">
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-1.5">
                <div className="w-2.5 h-2.5 rounded-full bg-[#7FB8A3]" />
