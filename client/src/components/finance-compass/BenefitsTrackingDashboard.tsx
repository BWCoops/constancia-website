    ...
    <Card data-testid="card-phased-benefits">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Zap className="h-5 w-5 text-[#7FB8A3]" />
                  ...
                  <div className="flex-1 pb-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className="bg-[#7FB8A3] text-xs">
...
function BenefitsSummaryCard({ 
  ...
  return (
    <Card className="bg-gradient-to-br from-[#12161D] to-[#7FB8A3] text-white" data-testid="card-benefits-summary">
      <CardContent className="py-6">
        <div className="grid sm:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <div className="text-xs text-[#C77A93] mt-1">{label}</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold mb-1">
              {displayTimeline}
            ...
            <div className="text-xs text-[#C77A93] mt-1">
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-[#C77A93] mt-1">Across all dimensions</div>
          </div>
        </div>
      </CardContent>
    </Card>
