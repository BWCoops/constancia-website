      ...
      <Card className="shadow-lg overflow-hidden" data-testid="card-maturity-indicator">
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Clock className="h-5 w-5 text-[#7FB8A3]" />
            {title}
          </CardTitle>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            ...
            <div className="p-3 rounded-lg bg-[#7FB8A3]/5 dark:bg-[#7FB8A3]/20 text-center">
              <div className="text-xs text-muted-foreground mb-1">Percentile</div>
              <div className="text-lg font-bold text-[#7FB8A3]">
                {score >= 70 ? 'Top 15%' : score >= 50 ? 'Top 40%' : score >= 35 ? 'Top 60%' : 'Top 80%'}
              </div>
            </div>
            <div className="p-3 rounded-lg bg-[#C77A93]/10 dark:bg-[#C77A93]/20 text-center">
            ...
            <div className="p-3 rounded-lg bg-muted/50 mb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Calendar className="h-5 w-5 text-[#7FB8A3]" />
                  <div>
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-2">
                {dynamicRecommendations.map((rec, index) => (
                  ...
                  >
                    <CheckCircle className="h-4 w-4 text-[#7FB8A3] mt-0.5 flex-shrink-0" />
                    <span>{rec}</span>
                  </motion.li>
                ))}
              </ul>
            ...
            <div className="mt-4 pt-4 border-t">
              ...
              <div className="grid grid-cols-4 gap-2">
                {Object.entries(dimensionScores).slice(0, 8).map(([dim, dimScore]) => {
                  const dimColor = dimScore >= 70 ? '#7FB8A3' : dimScore >= 50 ? '#12161D' : '#f59e0b';
                  return (
