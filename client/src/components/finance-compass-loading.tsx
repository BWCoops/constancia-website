...
export function FinanceCompassLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#02205B] via-[#034a5a] to-[#02205B]">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)]">
        <div className="text-center px-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0884AA]/30 mb-4">
