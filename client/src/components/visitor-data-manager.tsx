  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 text-[#F6F3EE]/60 hover:text-[#7FB8A3] transition-colors text-sm"
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between py-3 border-t border-[#F6F3EE]/10">
                      <div className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-[#7FB8A3]" />
...
function DataRow({ icon: Icon, label, value, testId }: DataRowProps) {
  return (
    <div className="flex items-center gap-2 text-sm">
      <Icon className="w-3.5 h-3.5 text-[#7FB8A3] flex-shrink-0" />
