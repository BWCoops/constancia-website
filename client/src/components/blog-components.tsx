...
export function KeyTakeawayBox({ children }: KeyTakeawayBoxProps) {
  return (
    ...
    >
      <div className="absolute -left-3 top-0 bottom-0 w-1 bg-gradient-to-b from-[#C77A93] via-[#7FB8A3] to-[#12161D] rounded-full" />
      <div className="p-6 bg-gradient-to-br from-[#12161D]/5 via-[#7FB8A3]/8 to-[#C77A93]/10 dark:from-[#12161D]/20 dark:via-[#7FB8A3]/15 dark:to-[#C77A93]/10 border border-[#C77A93]/20 rounded-xl ml-2">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center shadow-lg shadow-[#C77A93]/20">
            <Lightbulb className="w-5 h-5 text-white" />
          </div>
          <div className="flex-1">
            <div className="text-xs font-semibold uppercase tracking-wider text-[#7FB8A3] dark:text-[#C77A93] mb-2">
              Key Takeaway
            </div>
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center shadow-lg">
          <Lightbulb className="w-5 h-5 text-white" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {takeaways.map((takeaway, index) => (
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#C77A93]/20 to-[#7FB8A3]/20 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative p-5 bg-gradient-to-br from-[#12161D]/5 via-[#7FB8A3]/8 to-[#C77A93]/10 dark:from-[#12161D]/20 dark:via-[#7FB8A3]/15 dark:to-[#C77A93]/10 border border-[#C77A93]/20 rounded-xl h-full">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center text-white font-bold text-sm shadow-lg">
                  {index + 1}
                </div>
...
export function RadialPillarsChart({ title, pillars }: RadialPillarsChartProps) {
  ...
  return (
    ...
    >
      <div className="relative bg-gradient-to-br from-[#12161D] via-[#041a4a] to-[#7FB8A3] rounded-2xl p-8 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-[#C77A93] to-[#7FB8A3] mx-auto rounded-full" />
          </div>

          <div className="relative flex flex-col items-center">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center shadow-2xl shadow-[#C77A93]/30 mb-8 z-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 w-full">
              {pillars.map((pillar, index) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-white dark:bg-card border border-[#C77A93]/30 rounded-xl p-4 h-full hover:shadow-xl hover:border-[#C77A93]/60 transition-all duration-300 shadow-lg">
                      <div className="flex flex-col items-center text-center">
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center mb-3 shadow-md">
                          <IconComponent className="w-6 h-6 text-white" />
                        </div>
                        <div className="text-[#7FB8A3] dark:text-[#C77A93] text-xs font-bold mb-1">Pillar {index + 1}</div>
    ...
    >
      <div className="mb-6 flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#12161D] to-[#7FB8A3] flex items-center justify-center">
          <CheckCircle2 className="w-5 h-5 text-[#C77A93]" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {factors.map((factor, index) => {
          ...
          return (
            ...
            >
              <div className="bg-card border border-border rounded-xl p-5 h-full hover:border-[#C77A93]/30 hover:shadow-lg hover:shadow-[#C77A93]/5 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-[#12161D] to-[#7FB8A3] flex items-center justify-center shadow-lg">
                    <IconComponent className="w-6 h-6 text-[#C77A93]" />
                  </div>
                  <div className="flex-1">
...
export function ImplementationTimeline({ phases }: ImplementationTimelineProps) {
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center">
      ...
      <div className="relative">
        <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#C77A93] via-[#7FB8A3] to-[#12161D]" />
        ...
        <div className="space-y-6">
          {phases.map((phase, index) => {
            ...
            return (
              ...
              >
                <div className="absolute left-0 w-12 h-12 rounded-full bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center text-white shadow-lg shadow-[#C77A93]/20 z-10">
                  <IconComponent className="w-6 h-6" />
                </div>
                
                <div className="bg-card border border-border rounded-xl p-5 hover:border-[#C77A93]/30 hover:shadow-lg transition-all duration-300">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <h4 className="font-semibold text-foreground">{phase.title}</h4>
                    <span className="text-xs px-2 py-1 rounded-full bg-[#C77A93]/10 text-[#7FB8A3] dark:text-[#C77A93] font-medium">
                      {phase.timeframe}
                    </span>
                  </div>
...
export function FAQAccordion({ items }: FAQAccordionProps) {
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#12161D] to-[#7FB8A3] flex items-center justify-center">
          <HelpCircle className="w-5 h-5 text-[#C77A93]" />
        </div>
      ...
      <div className="border border-border rounded-xl overflow-hidden bg-card">
        <Accordion type="single" collapsible className="w-full">
          {items.map((item, index) => (
            ...
            >
              <AccordionTrigger 
                className="px-6 py-4 text-left font-semibold text-foreground hover:no-underline hover:bg-muted/50 transition-colors [&[data-state=open]]:bg-[#C77A93]/5 dark:[&[data-state=open]]:bg-[#C77A93]/10"
                data-testid={`faq-trigger-${index}`}
              >
                <div className="flex items-center gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#C77A93]/10 flex items-center justify-center text-xs font-bold text-[#7FB8A3] dark:text-[#C77A93]">
                    {index + 1}
                  </span>
...
export function StatHighlight({ stat, label, source, trend }: StatHighlightProps) {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#12161D] via-[#1E2630] to-[#7FB8A3] p-6 text-center shadow-xl">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-50" />
        
        <div className="relative z-10">
          <div className="flex items-center justify-center gap-2 mb-2">
            <BarChart3 className="w-5 h-5 text-[#C77A93]/70" />
          </div>
          <div className="text-4xl md:text-5xl font-bold text-[#C77A93] mb-2 tracking-tight">
            {stat}
          </div>
          ...
          {trend && (
            <div className="flex items-center justify-center gap-1 text-xs text-[#C77A93]">
...
export function ComparisonTableHead({ children }: { children: React.ReactNode }) {
  return (
    <thead className="bg-gradient-to-r from-[#12161D] to-[#7FB8A3] text-white sticky top-0 z-10">
      {children}
    </thead>
  );
}
...
const phaseColors = {
  primary: {
    bg: 'from-[#C77A93] to-[#7FB8A3]',
    border: 'border-[#C77A93]',
    text: 'text-[#C77A93]',
    light: 'bg-[#C77A93]/10',
    ring: 'ring-[#C77A93]/30',
  },
  secondary: {
    bg: 'from-[#7FB8A3] to-[#12161D]',
    border: 'border-[#7FB8A3]',
    text: 'text-[#7FB8A3] dark:text-[#C77A93]/80',
    light: 'bg-[#7FB8A3]/10',
    ring: 'ring-[#7FB8A3]/30',
  },
  tertiary: {
    bg: 'from-[#12161D] to-[#1E2630]',
    border: 'border-[#12161D]',
    text: 'text-[#12161D] dark:text-[#C77A93]/60',
    light: 'bg-[#12161D]/10',
    ring: 'ring-[#12161D]/30',
  },
};
...
export function TransformationTimeline({ title, subtitle, phases }: TransformationTimelineProps) {
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="absolute left-6 md:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#C77A93] via-[#7FB8A3] to-[#12161D]" />
          ...
          {phases.map((phase, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`p-5 rounded-xl border ${colorScheme.border}/30 ${colorScheme.light} hover:${colorScheme.light.replace('/10', '/20')} transition-colors`}>
                  ...
                  {phase.objective && (
                    <div className="flex items-start gap-2 mb-4 p-3 rounded-lg bg-background/60 border border-border/50">
                      <Target className="w-4 h-4 text-[#7FB8A3] dark:text-[#C77A93] flex-shrink-0 mt-0.5" />
                      <div>
                        <span className="text-xs font-semibold uppercase tracking-wider text-[#7FB8A3] dark:text-[#C77A93]">Objective</span>
                  ...
                  {phase.subPhases && phase.subPhases.length > 0 && (
                    <div className="space-y-3 mt-4">
                      {phase.subPhases.map((subPhase, subIndex) => (
                        ...
                        >
                          <div className="flex-shrink-0 w-8 h-8 rounded-md bg-gradient-to-br from-[#C77A93]/20 to-[#7FB8A3]/20 flex items-center justify-center border border-[#C77A93]/30">
                            <span className="text-xs font-bold text-[#7FB8A3] dark:text-[#C77A93]">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <span className="text-xs px-2 py-0.5 rounded-full bg-[#C77A93]/10 text-[#7FB8A3] dark:text-[#C77A93] font-medium">
                                {subPhase.timeframe}
                              </span>
                            </div>
                ...
                {!isLast && (
                  <div className="absolute left-[1.4rem] md:left-[1.85rem] top-full h-6 w-0.5 bg-gradient-to-b from-[#7FB8A3]/50 to-transparent" />
                )}
              </div>
            );
          })}
...
export function HorizonTimeline({ horizons }: HorizonTimelineProps) {
  const horizonColors = [
    { bg: 'from-[#C77A93] to-[#7FB8A3]', card: 'from-[#C77A93]/5 to-[#7FB8A3]/10', border: 'border-[#C77A93]/40' },
    { bg: 'from-[#7FB8A3] to-[#12161D]', card: 'from-[#7FB8A3]/5 to-[#12161D]/10', border: 'border-[#7FB8A3]/40' },
    { bg: 'from-[#12161D] to-[#1E2630]', card: 'from-[#12161D]/5 to-[#1E2630]/10', border: 'border-[#12161D]/40' },
  ];
              ...
              {horizon.phases && horizon.phases.length > 0 && (
                <div className="space-y-2">
                  {horizon.phases.map((phase, phaseIndex) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-md bg-[#C77A93]/10 flex items-center justify-center border border-[#C77A93]/20">
                        <span className="text-xs font-bold text-[#7FB8A3] dark:text-[#C77A93]">
...
export function SectionHeading({ level, children }: SectionHeadingProps) {
  ...
  if (level === 2) {
    return (
      <h2 
        className={`${baseClasses} text-2xl mt-10 mb-4 text-[#12161D] dark:text-[#C77A93]`}
      >
        <span className="w-1 h-8 bg-gradient-to-b from-[#C77A93] to-[#7FB8A3] rounded-full" />
        {children}
      </h2>
    );
  }
  ...
  return (
    <h3 
      className={`${baseClasses} text-xl mt-6 mb-3 text-[#7FB8A3] dark:text-[#C77A93]/80`}
    >
      {children}
    </h3>
  );
...
export function ListItem({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex items-start gap-2">
      <CheckCircle2 className="w-4 h-4 text-[#C77A93] flex-shrink-0 mt-1" />
      <span>{children}</span>
    </li>
  );
}
      ...
      <div className="p-4 sm:p-6 bg-card border border-border rounded-xl shadow-sm">
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-[#12161D] to-[#7FB8A3] flex items-center justify-center flex-shrink-0">
            {type === 'pie' ? (
              <PieChart className="w-4 h-4 sm:w-5 sm:h-5 text-[#C77A93]" />
            ) : (
              <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-[#C77A93]" />
            )}
          </div>
...
export function ResourceDownload({ slug, label, description }: { slug: string; label: string; description?: string }) {
  return (
    <div className="my-8 relative overflow-visible" data-testid={`resource-download-${slug}`}>
      <div className="absolute -left-3 top-0 bottom-0 w-1 bg-gradient-to-b from-[#C77A93] via-[#7FB8A3] to-[#12161D] rounded-full" />
      <div className="p-6 bg-gradient-to-br from-[#12161D]/8 via-[#7FB8A3]/10 to-[#C77A93]/12 dark:from-[#12161D]/25 dark:via-[#7FB8A3]/20 dark:to-[#C77A93]/15 border border-[#C77A93]/30 rounded-xl ml-2 shadow-lg shadow-[#C77A93]/5">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center shadow-lg shadow-[#C77A93]/20">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-semibold uppercase tracking-wider text-[#7FB8A3] dark:text-[#C77A93] mb-1">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <a 
              ...
              className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#12161D] to-[#7FB8A3] hover:from-[#7FB8A3] hover:to-[#C77A93] font-semibold rounded-lg transition-all duration-300 shadow-lg shadow-[#12161D]/20 hover:shadow-[#C77A93]/30 hover:scale-105 whitespace-nowrap"
              style={{ color: '#FFFFFF' }}
            ...
            <a 
              href="/resources"
              className="inline-flex items-center gap-2 px-4 py-3 text-[#7FB8A3] dark:text-[#C77A93] hover:text-[#12161D] dark:hover:text-white font-medium rounded-lg transition-colors whitespace-nowrap hover:bg-[#C77A93]/10"
...
export function InlineBlogImage({ src, alt, caption, type = "stock", alignment = "center" }: InlineBlogImageProps) {
  ...
  const typeStyles = {
    ...
    generated: "ring-2 ring-[#C77A93]/30",
    brand: "ring-2 ring-gradient-to-r from-[#12161D] to-[#C77A93]",
  };
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <div className="bg-white/90 dark:bg-gray-900/90 rounded-full p-3 shadow-lg transform scale-0 group-hover:scale-100 transition-transform duration-300">
              <ZoomIn className="w-5 h-5 text-[#12161D] dark:text-[#C77A93]" />
            </div>
          </div>
          {type === "generated" && (
            <div className="absolute top-3 right-3 bg-gradient-to-r from-[#12161D] to-[#7FB8A3] text-white text-xs font-medium px-2 py-1 rounded-full shadow-lg">
              AI Generated
            </div>
          )}
        </div>
          ...
          <ul className="space-y-3">
            {references.map((ref, index) => {
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-[#C77A93] to-[#7FB8A3] flex items-center justify-center mt-0.5 shadow-md">
