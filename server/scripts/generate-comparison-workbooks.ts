...
async function generateWorkbook(
  ...
  scoreSheet.addRow(['Generated by 1QG - Independent EPM & ERP Advisory']);
  ...
  instructionsSheet.addRow([`1QG ${type.toUpperCase()} Selection Toolkit - Instructions`]);
  ...
  const instructions = [
    ...
    '',
    'About the Scores:',
    '• Scores are from 1-10 based on 1QG\'s independent research',
    ...
    `https://1qg.com/${type}-comparison`,
    '',
    'Contact 1QG for independent advisory:',
    'info@1qg.com | https://1qg.com',
  ];
