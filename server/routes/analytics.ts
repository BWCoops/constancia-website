...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(135deg, #12161D 0%, #7FB8A3 100%); padding: 24px; border-radius: 12px 12px 0 0; text-align: center;">
      ${getEmailLogoHtml({ variant: 'white' })}
      <h1 style="color: #C77A93; margin: 16px 0 8px 0; font-size: 22px; font-weight: 600;">New Widget Lead</h1>
    ...
    <div style="background-color: #ffffff; padding: 24px; border-radius: 0 0 12px 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
      <h2 style="color: #12161D; margin: 0 0 16px 0; font-size: 18px; border-bottom: 2px solid #C77A93; padding-bottom: 8px;">Contact Details</h2>
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
        ...
        <tr>
          ...
          <td style="padding: 8px 0; color: #12161D; font-weight: 500;"><a href="mailto:${data.email}" style="color: #7FB8A3;">${data.email}</a></td>
        </tr>
        <tr>
      ...
      <h2 style="color: #12161D; margin: 0 0 16px 0; font-size: 18px; border-bottom: 2px solid #C77A93; padding-bottom: 8px;">Organisation Profile</h2>
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
        <tr>
      ...
      <h2 style="color: #12161D; margin: 0 0 16px 0; font-size: 18px; border-bottom: 2px solid #C77A93; padding-bottom: 8px;">Assessment Results</h2>
      <div style="background: linear-gradient(135deg, #12161D 0%, #7FB8A3 100%); border-radius: 8px; padding: 16px; margin-bottom: 16px; text-align: center;">
        <div style="font-size: 36px; font-weight: 700; color: #C77A93;">${data.score}%</div>
      ...
      <div style="text-align: center; margin-top: 16px;">
        <a href="${hubspotUrl}" style="display: inline-block; background: linear-gradient(135deg, #C77A93 0%, #7FB8A3 100%); color: #12161D; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Add to HubSpot Manually
        </a>
      </div>` : `
      <div style="text-align: center; margin-top: 16px;">
        <a href="https://app.hubspot.com/contacts" style="display: inline-block; background: linear-gradient(135deg, #7FB8A3 0%, #12161D 100%); color: #fff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 500; font-size: 14px;">
          View in HubSpot
        </a>
      </div>`}
...
function buildWidgetResultsEmailHtml(data: z.infer<typeof widgetEmailResultsSchema>): string {
  ...
  const industrySection = data.industryInsight ? `
    <table role="presentation" style="width: 100%; margin-bottom: 24px; border-collapse: collapse;">
      <tr>
        <td style="padding: 20px; background-color: #eff6ff; border-radius: 8px; border-left: 4px solid #7FB8A3;">
        ...
        <table role="presentation" style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="width: 32px; vertical-align: top; padding-right: 12px;">
              <div style="width: 28px; height: 28px; background-color: #7FB8A3; border-radius: 50%; text-align: center; line-height: 28px; color: #ffffff; font-weight: 600; font-size: 14px;">
                ${idx + 1}
              </div>
            </td>
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; margin: 0 auto; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td align="center" style="background-color: #12161D; padding: 40px 30px;">
              ...
              <h1 style="margin: 0; font-size: 24px; font-weight: 600; color: #C77A93; line-height: 1.3;">
              ...
              <table role="presentation" style="width: 100%; margin-bottom: 24px; border-collapse: collapse;">
                <tr>
                  <td style="background-color: #12161D; border-radius: 12px; padding: 32px; text-align: center;">
                    <h2 style="margin: 0 0 12px 0; font-size: 22px; font-weight: 600; color: #C77A93;">Ready for Deeper Insights?</h2>
                    ...
                    <a href="https://constancia.io/finance-compass" target="_blank" style="display: inline-block; padding: 16px 40px; background-color: #C77A93; color: #12161D; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 8px;">
                ...
                <tr>
                  <td style="text-align: center;">
                    ...
                    <p style="margin: 0 0 16px 0; font-size: 13px; color: #6b7280;">
                      <a href="mailto:info@constancia.io" style="color: #7FB8A3; text-decoration: none;">info@constancia.io</a>
                      &nbsp;|&nbsp;
                      <a href="https://constancia.io" style="color: #7FB8A3; text-decoration: none;">www.constancia.io</a>
                    </p>
